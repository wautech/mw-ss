...
$(document).on('input','.chat_input',function(){
    ...
    function getChatsUpdates() {
        ...
        var beforeCount = $('.messages ul li').length;  // Related to Chat notifications
        $.ajax({
            type: "POST",
            ...
            success: function (data) {
                ...
                // Start Related to Chat notifications
                var afterCount = $('.messages ul li').length;
                if (afterCount > beforeCount) {
                    playGlobalChatSound();
                }
                // End Related to Chat notifications
